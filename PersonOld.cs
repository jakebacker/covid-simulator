...
{
    [Obsolete("PersonOld is deprecated. Will be replaced with something else")]
    public class PersonOld
    {
        ...
        public PersonOld(String name, InfectedStatus status=InfectedStatus.Susceptible, int covidLength=-1)
        {
            _name = name;
            _status = status;
        ...
        public void AddConnection(PersonOld person2, ConnectionType type)
        {
